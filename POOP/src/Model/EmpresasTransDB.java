...
/**
 * Base de dados de todas as empresas Transportadoras
 */
public class EmpresasTransDB implements Serializable{
    ...
    */
    ...
    public List<EmpresasTrans> empresasNoRaio(double la, double lo,double la1, double lo1 ) {//la latitude loja e lo longitude loja
        return this.empresas
                .values()
                .stream()
    ...
    } // depois podemos juntar o .get(0) para pegar a 1 se for necessario mas como e o cliente que escolhe nao sei se sera entao mudei

    /**
     * Método que obtém as empresas que estão num determinado raio e livres dado uma loja e um user 
     */
    public List<EmpresasTrans> empresasNoRaio(Lojas l, User u) {//la latitude loja e lo longitude loja
        return this.empresas
                .values()
                .stream()
    ...
    public List<EmpresasTrans> empresasNoRaioMed(double la, double lo,double la1, double lo1) {//la latitude loja e lo longitude loja
        return this.empresas
                .values()
                .stream()
    ...
    public List<EmpresasTrans> empresasNoRaioMed(Lojas l , User u) {//la latitude loja e lo longitude loja
        return this.empresas
                .values()
                .stream()
