...
public class UsersDB implements Serializable{
    ...
    private Map<String, User> baseDadosUti; // key é o codUtilizador, value e o utilizador
    ...
    void addUtilizador(User u) throws UserJaExisteException{
       ...
       if(this.baseDadosUti.putIfAbsent(u.getCodUtilizador(), u) !=null)//returns null if no value is previously mapped to the key.
