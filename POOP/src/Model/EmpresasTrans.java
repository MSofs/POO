...
public class EmpresasTrans implements Serializable{
    ...
    */   
    ...
    public double calculaPrecoDist( double dist){ //dist = return da funçao acima
    ...
    public double calculaPrecoPeso( Encomendas e){ //dist = return da funçao acima
        return e.getPeso() * this.getPrecoPeso(); //Ter em atencao se é para multiplicar pelo peso da encomenda
    }
    ...
    public double calculaPrecoTempo( Lojas l){ //dist = return da funçao acima
        double tempo = 0.0;
        if(l.filaEspera)
