...
public class Lojas implements Serializable{
    ...
    private double lat;
    private double lon;
    private double tpAtend; // tempo de atendimento na loja
    public boolean filaEspera;
    public List<EncomendaAceite> encA; //encomendas aceites para a loja respetiva == fila de espera
    public List<Encomendas> encR;//histotico de encomendas
    ...
    public void produzEncomenda(EncomendasDB bsdE) throws NaoExisteEncomendaException {
        while(this.encA.size()>0){
            // sleep(); para demorar x tempo a passar as encomendas ?
    ...
    public double distanceLojaU( User u) {
        ...
        //supostamnte estamos a calcular a distancia entre o loja e o voluntario
        //retorna em kms
        return dist;
    }
